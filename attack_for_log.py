...
from DFR_log import DFR_model1
#from DFR_log import DFR_model1#########################################################
from happy_log import happy_model1
from lenet_log import LeNet1
#from lenet_log import LeNet1
# Helper functions
...
class PixelAttacker:
    def __init__(self, models, data, class_names, dimensions=(3, 28)):  #28,28
        # Load data and model
        self.models = models
    ...
    def attack(self, img, model, target=None, pixel_count=1,
        ...
        print('66666666666',attack_result.x)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pixels', nargs='+', default=[1, 3, 5, 10 ], type=int,  # 1,3,5,10,15,20,25,30
    ...
    # data_path = '/home/ailab/YI ZENG/Research/Classified/tra/MalwareData10000/data_Mrest.npy'
    # label_path = '/home/ailab/YI ZENG/Research/Classified/tra/MalwareData10000/label_Mrest.npy'
    data_path='../0_AEEA_dataset/MalwareAttack_log_dataset/normal_attack_data.npy'
    label_path='../0_AEEA_dataset/MalwareAttack_log_dataset/attack_labels.npy'
    data = np.load(data_path)
    label_n = np.load(label_path)
    print(label_n[1:10])
