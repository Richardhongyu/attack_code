...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
    ...
    mutation : float or tuple(float, float), optional
        ...
        ``U[min, max)``. vcvccan help speed convergence significantly.
    ...
    To improve your chances of finding a global minimum use h-igher `popsize`
    ...
    def __next__(self):
        ...
        for candidate,(energy,trial) in enumerate(zip(energies, trials)):
            ...
            if energy < self.population_energies[candidate]:
                ...
                #print('population_energies[0]',self.population_energies[0])
                #print()
