...
import helper
from random_generate_qzh import Random_Attack
...
class PixelAttacker:
    ...
    def attack(self, img, model, target=None, pixel_count=1,
        ...
        return [model.name, pixel_count, img, actual_class, predicted_class, success, cdiff, prior_probs,
                predicted_probs, attack_result, L2_norm]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pixels', nargs='+', default=
                        [1,3,5,10,15,20] #
    ...
    parser.add_argument('--save', default='rand-happy_results.pkl', help='Save location for the results (pickle)')
